    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-6 text-white">
          ...
          <p className="text-emerald-100 text-sm mt-1">Credit Balance</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          ...
          <p className="text-3xl font-bold text-slate-900">{data?.referralCode?.total_referrals || 0}</p>
          <p className="text-slate-500 text-sm mt-1">Friends Referred</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          ...
          <p className="text-slate-500 text-sm mt-1">Total Earned</p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex-shrink-0">
            <div className="flex items-center gap-2 bg-white/10 rounded-xl p-2">
              <div className="px-4 py-2 bg-white text-slate-900 font-mono font-bold text-lg rounded-lg">
        ...
        <div className="mt-6 pt-6 border-t border-white/10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366]/20 hover:bg-[#25D366]/30 rounded-lg transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#1DA1F2]/20 hover:bg-[#1DA1F2]/30 rounded-lg transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#1877F2]/20 hover:bg-[#1877F2]/30 rounded-lg transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Send your unique referral code to friends</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 bg-emerald-600 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">They get {formatPrice(data?.referralCode?.referee_reward_pence || 500)} credit instantly</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 bg-emerald-600 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
            ...
            <div>
              <h4 className="font-medium text-slate-900">You Earn Rewards</h4>
              <p className="text-sm text-slate-600">Get {formatPrice(data?.referralCode?.referrer_reward_pence || 500)} when they make a purchase</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {data?.referrals && data.referrals.length > 0 ? (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  {referral.referrer_credited_at ? (
                    ...
                    <span className="text-slate-400 text-sm">Waiting for first order</span>
                  )}
            ...
            <div className="text-center py-12 bg-slate-50 rounded-xl">
              ...
              <p className="text-sm text-slate-500">Share your code to start earning rewards</p>
            </div>
          )}
        </div>
      ) : (
        <div className="space-y-4">
          {data?.transactions && data.transactions.length > 0 ? (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    tx.amount_pence > 0 ? 'bg-emerald-100' : 'bg-red-100'
                  }`}>
                ...
                <div className="text-right">
                  <p className={`font-bold ${tx.amount_pence > 0 ? 'text-emerald-600' : 'text-red-600'}`}>
            ...
            <div className="text-center py-12 bg-slate-50 rounded-xl">
              ...
              <p className="text-sm text-slate-500">Your credit history will appear here</p>
            </div>
          )}
        </div>
      )}
