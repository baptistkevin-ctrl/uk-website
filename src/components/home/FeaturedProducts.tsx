...
export function FeaturedProducts({ products, categories }: FeaturedProductsProps) {
  ...
  return (
    <section className="py-10 bg-(--color-surface)">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-1 ml-4">
              <button className="w-7 h-7 border border-(--color-border) rounded flex items-center justify-center hover:bg-background transition-colors">
                <ChevronLeft className="h-4 w-4 text-(--color-text-muted)" />
              </button>
              <button className="w-7 h-7 border border-(--color-border) rounded flex items-center justify-center hover:bg-background transition-colors">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-12 bg-background rounded-xl">
            <p className="text-(--color-text-muted)">No products found in this category.</p>
          </div>
        )}
